...
// ======================================================================================================================
  ...
  public function getJobOfferDataPendings($id){
        $this->db->select('*');
        ...
        $this->db->where('checkmate_project_resources.resources_id',$id);
         $this->db->where('checkmate_project_resources.status',0);
        $result = $this->db->get()->result_array();
        return $result;
    ...
    public function getJobOfferData($id)
    {
        ...
        $this->db->from('checkmate_project_resources');
        $this->db->join('checkmate_project','checkmate_project.id = checkmate_project_resources.project_id','inner');
        $this->db->where('checkmate_project_resources.user_id',$id);
        $result = $this->db->get()->result_array();
        return $result;
    }

    public function getTableCounts($tableName,$user_id)
    {
        $this->db->select('*');
        $this->db->where('user_id', $user_id);
    ...
    public function createProjectLogs($data)
    {
        return $this->db->insert('checkmate_project_logs', $data);
    }

    public function getProjectPreviousLogs($milestone_id)
    {
        $this->db->select('*');
        $this->db->from('checkmate_project_logs');
