		...
		<div class="container">
			<div class="row">
				<div class="logo">
					...
					<a href="https://www.intervene.io/getstarted/index.php" title="Intervene"><img alt="Intervene" src="images/intervenenew.png" style="height:40px"></a>
				</div>		<!-- /.logo -->
                ...
                <div id="main-menu" class="menu main-menu">
                    <ul>
                        <li class="item-menu <?php echo $active['folder']; ?> "><a href="https://www.intervene.io/getstarted/index.php">Home</a></li>
                    </ul>
                </div>
                <?php } ?>
				<div class="users">
