...
//Teacher 
$childsc= ("SELECT * FROM terms WHERE taxonomy= 'category' AND active= 1 {$condition} AND parent= {$termId} ORDER BY name ASC");
...
<?php //include("MoodleWebServices/enroll_course_teacher.php");?>
<?php ob_flush(); ?>
