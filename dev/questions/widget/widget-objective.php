<div id="objective" class="widget clear fullwith">
     <h4 class="widget-title"><i class="fa fa-life-ring"></i>

	<a href="#" class="menu_heading">Objectives</a></h4>


</div>

<div  class="objective_widget widget-content">
	<?php if($role==0):?>
	<p class="add_new">
	...
	<p class="add_new">
		<i class="fa fa-plus-circle"></i>
		<a href="manage_objectives.php" class="popup_form" >All Objectives</a>
	</p>
