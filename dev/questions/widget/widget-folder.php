 <div id="folder" class="widget clear fullwith">
     <h4 class="widget-title"><i class="fa fa-folder"></i>

	<a href="#" class="menu_heading">Folders</a></h4>


</div>

<div  class="folder_widget widget-content">
		...
		if( mysql_num_rows($categories) > 0 ) {
			...
			while( $category = mysql_fetch_assoc($categories) ) {
				...
				echo ($current || $category['id'] == $taxonomy)
					...
					: '<li style="border-bottom: 1px solid #d5d5d7;padding:10px">';
