...
<div class="panel panel-default">
  <div class="panel-heading">
      <h3 class="panel-title" style="text-align:center">Session List</h3>
  </div>
  <div class="panel-body">
    ...
    <tbody>
         <tr data-child-value="
            <table class='table'>
               <tr>
                   <td>Session ID</td><td>5520</td>
                </tr>
                <tr>
                   <td>Session Time</td><td>Dec 2, 2020 10:30am</td>
                </tr>
                <tr>
                   <td>Virtual Board</td><td>Newrow</td>
                </tr>
                <tr>
                   <td>School</td><td>Harts Bluff ISD</td>
                </tr>
                <tr>
                   <td>District</td><td>HARTS BLUFF ISD</td>
                <tr>
                 <tr>
                   <td>Lesson</td><td>Test Lession</td>
                <tr>
                <tr>
                   <td>Class list of students</td><td>ADDISON SPURGEON</td>
                <tr>
                <tr>
                   <td>Create Date</td><td>Nov 05,2020 </td>
                <tr>
                <tr>
                   <td>Session Status</td><td>Assigned</td>
                <tr>
           </table>">
            <td class="details-control"></td>
            <td>Dec 2, 2020 10:30am</td>
            <td>5520</td>
            <td>Newrow</td>
            <td>Assigned</td>
            <td><a href="intervention_det.php?ses_id=5446" ><i class='glyphicon glyphicon-edit' style="color:bule"></i></a>&nbsp;&nbsp;<a href="edit_session.php?sid=5446" ><i class='glyphicon glyphicon-remove-sign' style="color:red"></i></a></td>
        </tr>
         <tr data-child-value="
            <table class='table'>
               <tr>
         ...
         <tr data-child-value="
            <table class='table'>
               <tr>
                ...
                <tr>
                <tr>
                   <td>Create Date</td><td>Nov 07,2020 </td>
                <tr>
                <tr>
                   <td>Session Status</td><td>Assigned</td>
                <tr>
        ...
        <option  <?=$sel?> value="<?=$row['school_id']?>"><?=$row['SchoolName']?></option>
           ...
           <a href="intervention_list_latest.php" target="_blank"  title="Recent created Tutoring Sessions" 
            ...
            class="btn btn-success btn-md">Recent created</a>
						...
						<li title="Create new"><a href="create_session.php"><i class="fa fa-plus-circle"></i></a></li>	
