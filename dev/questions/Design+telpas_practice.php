...
<?php }?>
		 ...
		 <div class="w-1000" >
			 <div class="row text-center">
				  <h3 class="text-center" style="margin-bottom: 30px;"><strong>Week 1 Practice</strong></h3>
				  <div class="col-md-3" style="border-right: 2px solid #ccc;">
					  <td class="text-center">
						<p><strong>Course-Writing</strong></p>
						<p>Progress- 0% </p>
						<p> Status- <span style="color:##337ab7"><strong>Not Started</strong></span> </p>
						<a href="https://intervene.io/questions/telpas_practice.php?practStart=23" class="btn btn-primary btn-lg">START</a>
				  </div>
				  <div class="col-md-3" style="border-right: 2px solid #ccc;">
					  <p><strong>Course-Listening</strong> </p>
					  <p>Progress- 0% </p>
					  <p> Status- <span style="color:##337ab7"><strong>Not Started</strong></span> </p>
					  <a href="https://intervene.io/questions/telpas_practice.php?practStart=22" class="btn btn-primary btn-lg">START</a>
				  </div>
				  <div class="col-md-3" style="border-right: 2px solid #ccc;">
					 <p><strong>Course-Reading</strong> </p>
					 <p>Progress- 43% </p>
					 <p> Status- <span style="color:red"><strong>Incomplete</strong></span> </p>
					 <a href="https://intervene.io/questions/telpas_practice.php?practStart=21" class="btn btn-primary btn-lg">RESUME</a>
				  </div>
				  <div class="col-md-3">
					 <p><strong>Course-Speaking </strong></p>
					 <p>Progress- 0% </p>
					 <p> Status- <span style="color:##337ab7"><strong>Not Started</strong></span> </p>
					 <a href="https://intervene.io/questions/telpas_practice.php?practStart=20" class="btn btn-primary btn-lg">START</a>
				  </div>
