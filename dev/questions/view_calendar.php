...
AND ses_start_time BETWEEN '$getdate' AND '$end_date'  AND teacher_id='$user_id'";  
        ...
        $sql_homewrk_intxxx=" (Select log.id, log.ses_start_time, log.type,log.tut_status FROM  int_schools_x_sessions_log log WHERE  type = 'homework' 
        AND ses_start_time BETWEEN '$getdate' AND '$end_date'  AND teacher_id='$user_id' )
UNION
(
...
GROUP BY slot_stu.slot_id
 ...
 $sql_homewrk_int=" SELECT log1.id, log1.ses_start_time, slot_stu.type,log1.tut_status FROM int_slots_x_student_teacher slot_stu LEFT JOIN int_schools_x_sessions_log log1 ON slot_stu.slot_id = log1.id 
WHERE slot_stu.type = 'intervention'  AND slot_stu.int_teacher_id='$user_id' AND log1.ses_start_time BETWEEN '$getdate' AND '$end_date'
GROUP BY slot_stu.slot_id ";
        ...
        /////////////Search calendar/////////////
         ...
         ////////////Search calendar///////////
            ...
            <div id="content" class="col-md-8">
                ...
                <form name="" id="" method="GET" action="view_calendar.php">
...
?>
   ...
   class="btn btn-default btn-xs">10:30 am</a>- Intervention   <br/>  </p>
