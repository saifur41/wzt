...
// find student list 
     ...
     $sel_class_id=$class_id;// master session
      ...
      //  Grade id .    
        ...
        // 
        // echo 'this is school',$master['school_id']; ?>
         <div id="textarea" style="display: block">
          <span> <strong class="text-primary">
          Grade:</strong> </span> <?php
          if($master['school_id']==130)
          {
            echo $master['grade_common'];
          }
          else
          {
          ...
          <span> <strong class="text-primary">Student List :</strong> </span>
          <?php 
          $ses_id=$_GET['ses_id'];
          $sql_student=" SELECT sx.slot_id,sx.launchurl,sx.student_id,s.id as sid,s.first_name,s.last_name FROM int_slots_x_student_teacher sx
          ...
          <p> 
 <a title="Back, Home" href="intervention_list.php" class="btn btn-success btn-sm">Back</a></p>
  </form><div class="clearnone">&nbsp;</div>
                    </div>    <!-- /.ct_display -->
                </div>
            </div>    <!-- /#content -->
