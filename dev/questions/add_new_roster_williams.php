             ...
             if (($handle = fopen($uploads_dir, "r")) !== FALSE) 
              while($line = fgetcsv($handle, 1000, ",")){
               ...
               if($d >= 1) {
                    ...
                    $Grade=  $arrG[$gradeNO];
                    $teacher_first_name =$line[6];
                    $teacher_last_name =$line[7];
...
echo '<script>window.location="add_new_roster_williams.php"</script>';
   }
   ?>
                        ...
                        <tbody>
                           <?php
                              ...
                              <td align="center">
                                ...
                                <a href="add_new_roster_williams.php?delid=<?= $res['id']?>" style="color: red"onclick="return confirm('Are you sure?')"><i class="fa fa-trash"></i></a>
                              </td>
                            </tr>
                           <?php 
                              $i++; } ?>
