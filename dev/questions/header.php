<?php 
   ...
   if(isset($_SESSION['login_id'])){ $user_teacher = $_SESSION['login_id'];}
     ...
     // Validate access ////
   	...
   	function isGlobalAdmin() {
   		$global_admin = array(
   			...
   			'superadmin@intervene.io',
   			'amccloud@intervene.io',
   			'kpryce@intervene.io',
   			'lroyston@intervene.io',
                           'team@intervene.io'
   		);
   	...
   	$role = checkRole();
           ...
           ////School Pages////////////////////
   	$pages = array('school_assessment_duplicate.php','edit_school_assessment.php','questions_list.php','school_assessment_list.php','school_assessment.php','school_assessment_step3.php','school_assessment_step2.php','school_assessment_step1.php','session-edit.php','session-detail.php','sessions-calendar.php','view-sessions.php','create-tutor-sessions.php','create-slot.php','view-slots.php','login.php', 'forgot-password.php', 'login_principal.php', 'school.php', 'student_login.php', 'student_assesments.php', 'demo_login.php','demo_student_login.php','school_result_upload.php',
   		'select_assessment.php','school_datadash_report_new.php','school_datadash_report.php');
   
   
   	///////////////////////////////// bulk-upload.php  , export_bulk_questions.php
   	# profile.php  , passages.php , folder.php
            $subAdminPageArr=array('single-passage.php',
   	 	                    'passages.php',
   	 	                    'folder.php',
   
   	 	                    'single-question.php',
   	 	                    'questions.php', //Basicpage
   	 	                     'login.php',
   	 	                      'profile.php',
   	 	                      'export_bulk_questions.php',
   	 	                      'bulk-upload.php',
   	 	                     
   	 	                   'admin_error.php');
   
   	  if(isset($_SESSION['ses_subdmin'])&&$_SESSION['ses_subdmin']=='yes'){ //Only allowedListed Sub-admin page- other go to Error
   
   	  	 if( !in_array(curPageName(), $subAdminPageArr) ) {
   
   	  	 	header("Location:logout.php"); exit;
   
   	  	 	echo 'Page not allowed'; die; 
   ...
   <head>
      ...
      <script type="text/javascript">
         tinymce.init({
         	...
         	AScgiloc : '<?php echo $siteUrl?>questions/php/svgimg.php',		//change me  
         ...
         <div class="container">
            <div class="row">
               <div class="logo">
                  ...
                  <a href="<?php echo $siteUrl?>" title="Intervene"><img alt="Intervene" src="images/intervenenew.png" style="height:40px"></a>
               </div>
               <!-- /.logo -->
               <button type="button" class="navbar-toggle" data-toggle="collapse" data-target="#menu-main">
                  <!-- button menu mobile --><!-- data-target -->
               ...
               <div id="main-menu" class="menu main-menu">
                  <ul>
                     <li class="item-menu <?php echo $active['folder']; ?> "><a href="<?php echo $siteUrl?>">Home</a></li>
                  </ul>
               ...
               <div class="users">
                  <p>
                       <?php  if($role == 0)
                { ?>         
                   <a class="btn btn-warning" href="https://form.asana.com?k=k3laCH4Gf2GkQWcO2nHLsg&d=823289861380499" target="_blank" style="color:#fff;margin-right: 15%;margin-left: 15%">REPORT ISSUE FUNCTION REQUEST</a> 
                       <?php } else if( $role == -1 && ( isset($_SESSION['schools_id']) && $_SESSION['schools_id'] > 0)){ ?>         <a class="btn btn-warning" href="https://form.asana.com?k=k3laCH4Gf2GkQWcO2nHLsg&d=823289861380499" target="_blank" style="color:#fff;margin-right: 15%;margin-left: 15%">REPORT ISSUE FUNCTION REQUEST</a> <?php } ?>
                     <?php
                        ...
                        if( isset($_SESSION['login_user']) || isset($_SESSION['student_id']) ||
                        isset($_SESSION['demo_user_id']) ) : ?>
                     <a href="<?=$profile_url?>" class="welcome">Welcome <?php if(isset($_SESSION['student_id'])&&$_SESSION['student_id'] !=''){echo $_SESSION['student_name']; }elseif($_SESSION['login_user']){ echo $_SESSION['login_user'];}else{ echo $_SESSION['demo_login_user'];}?>!</a>
                     ...
                     <!-- <a href="#" class="links no_padding">Sign up</a> -->
                     <?php endif;?>
                  </p>
               </div>
               <!-- /.users -->
         ...
         <div class="container">
            <div class="row">
               ...
               <div class="profile-item alert btn-warning text-center">
                  ...
                  <br />
                  <a href="<?php echo $siteUrl?>questions/folder.php">(Click here to refresh page if you've already confirmed account)</a>
               </div>
               <?php endif;?>
         ...
         <div class="container">
            <div class="row">
               <div class="profile-item alert btn-warning text-center">
                  ...
                  <br />
                  <a href="<?php echo $siteUrl?>questions/demo_folder.php">(Click here to refresh page if you've already confirmed account)</a>
               </div>
               <?php //if( !in_array(curPageName(), $data_dash_pages) ){ include("search-form.php"); } ?>
            </div>
         </div>
                        ...
                        if (isset($_POST['submit-renewal'])) {
                            ...
                            if($data == 'purchase_now'){
                               // $url = "https://docs.google.com/forms/d/e/1FAIpQLSfhCNWnfrxIDxXw_Q5bgz_Jvwd7suOhj34DqBhh8eQgvKjq4Q/viewform";
                                $url="<?php echo $siteUrl?>purchaseform.php";
