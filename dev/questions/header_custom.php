...
<?php
	...
	$pages = array('session-edit.php','session-detail.php','sessions-calendar.php','view-sessions.php','create-tutor-sessions.php','create-slot.php','view-slots.php','login.php', 'signup.php', 'forgot-password.php', 'login_principal.php', 'school.php', 'student_login.php', 'student_assesments.php', 'demo_login.php','demo_student_login.php');
...
<div id="wrapper" class="clear fullwidth">
	...
	<div id="header" class="clear fullwidth">
		<div class="container">
			<div class="row">
				<div class="logo">
					<h1>Intervene |Report</h1>
					<a href="../index.php" title="Less Test Prep">
					<img style="height: 40px;" alt="Intervene" src="images/logo.png" /></a>
				</div>		<!-- /.logo -->
