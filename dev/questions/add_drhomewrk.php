 ...
 $selected_date= (!empty($_POST['select_date'][$i])) ?$_POST['select_date'][$i]: date("Y-m-d"); 
    ...
    // $arr['lesson']['end_time']=$end_time;
      ...
      $arr['lesson'][]=array('les_id'=>$_POST['lesson'][$i],
       ...
       $sql_session= " INSERT INTO int_schools_x_sessions_log SET board_type='$curr_board',type='intervention',activity_start_time='$activity_time',ses_start_time='$start_time',"
                   ...
                   . "school_id='$school_id',lesson_id='$ses_lesson_id',quiz_id='$quiz_id',grade_id='".$_POST['grade']."', "
                            . "created_date='$today',teacher_id='0',district_id='$district_id' ";
...
$(document).ready(function(){
  ...
  $("#form_passageSTOP").submit(function(){
            ...
            <div id="content" class="col-md-8">
                <div id="single_question" class="content_wrap">
                    ...
                    <div class="ct_display clear">
                      ...
                      <select name="student[]" id="districtXXX" multiple="" size="4"  >
                <?php while ($district = mysql_fetch_assoc($district_qry)) { ?>
                            <option <?php if (in_array($district['id'], $assessment_district)) { ?> 
                              selected="selected" <?php } ?> value="<?php print $district['id']; ?>"> Stu <?php print $district['district_name']; ?></option>
                            <?php } ?>
                                    </select>
...
LEFT JOIN terms t ON p.grade_level_id = t.id WHERE p.school_id =".$school_id;
                     ...
                     <label for="lesson_name">Choose Grade:</label>
                                   ...
                                   <select name="grade" id="grade_id" class="required textbox" >
                                    <option value="2630">6th Grade Math</option><option value="2877">7th Grade Math</option></select>
                            ...
                            <option  <?= $sel ?> value="<?= $k ?>"><?= $kff ?></option> 
                             ...
                             <!-- Lesson -->
                              ...
                              <p>
                                    <label for="lesson_name">Choose  Assessement :</label>
                                    <select name="lesson[]" id="lesson" class="textbox" ti  >
