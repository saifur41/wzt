...
die;
                if($d >= 1) {
                      ...
                      $classname   =  $line[11];
                      $class_code  =  0;
                      $teacher_first_name  =  $line[12];
                      $teacher_last_name   =  $line[13];
                      $teacher_email       = trim($line[14]);
                      $teacher_unique_id   = trim($line[15]);
...
echo '<script>window.location="add_new_roster_Worthing.php"</script>';
   }
   ?>
                        ...
                        <tbody>
                           <?php
                              ...
                              <td align="center">
                                ...
                                <a href="add_new_roster_Worthing.php?delid=<?= $res['id']?>" style="color: red"onclick="return confirm('Are you sure?')"><i class="fa fa-trash"></i></a>
                              </td>
                            </tr>
                           <?php 
                              $i++; } ?>
