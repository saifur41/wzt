...
<div style="border: 1px solid black" class="row text-center">
    ...
    <h3>Give Access <?php // ="--Total Slot--".$ ?></h3>
          ...
          <a title="Upload a Result CSV" style=" margin-top:115px; " 
           href="school_result_upload.php" class="btn btn-danger btn-sm">Upload a Result CSV</a>
            ...
            <td><form name="logout" method="POST" action="">
                    <button type="submit" name="logout" class="btn btn-danger">Logout</button></form>
            ...
            <td colspan="8" title="Available"> 
                <p >
                    <strong class="text-danger" title="Remaining Tutors Sessions-<?=$avaiable_slots?>">
                        Remaining Sessions-<?=$avaiable_slots?></strong><br/>
                        <strong title="Used Tutors Sessions-<?=$tot_ses_used?>" class="text-success">Used Sessions-<?=$tot_ses_used?></strong>
                </p> 
