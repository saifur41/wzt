<?php
    /***
        ...
        @ Add student : limit 
        https://intervene.atlassian.net/browse/IIDS-146.
        @@@@@@@@@@@@@@@@@@@@@@@@@@@
        @ Testing session ON - auto assign, test-tutor. .\
        @ Tutoring_client_id :: intervene123456
        @ tutor need to accept session 
        @ Tick for - Test session(yes |no )

        @ Add 2 resource for -board :select at -Add time.
        @@@@@@@@@@@@@@@@@@@@@@@@
        client_id :: intervene
        @ Every intervention have client ID .
        ============================
    ...
    if (isset($_POST['create_submit'])) {    
        ...
        for($i=0; $i<count($_POST['lesson']); $i++) {
            ...
            **/     
            ...
            $sql_session= "INSERT 
                INTO int_schools_x_sessions_log 
                SET 
                Tutoring_client_id='$client_id',curr_active_board='$curr_active_board',
                board_type='$curr_active_board',type='intervention',
                activity_start_time='$activity_time',ses_start_time='$start_time',"
            ...
            if ($i==0) {  
                ...
                if (isset($_POST['is_testing'])) {
                    ...
                    $msg_success='Testing intervention Created! ';
        ...
        if ($curr_active_board=='newrow') {
            header("Location:create_session_step2.php?id=".$first_ses_id); 
            exit;
        }
    }
    ///////Create Intervention Session //////
    ...
    **/ 
    function job_notify_tutors($arr_tutors,$ses_id) {
        ...
        foreach ($arr_tutors as $key => $arr) {
            ...
            $msg_query1= mysql_query("INSERT 
                INTO notifications 
                (receiver_id, type, sender_type,type_id, info, created_at) 
                VALUES
                    ('$tutorId','jobs',
    ...
    if (isset($_GET['id']) && $_GET['id'] > 0 && $_GET['action'] == 'edit') {
            ...
            <div id="content" class="col-md-8">
                <div id="single_question" class="content_wrap">
                    ...
                    <div class="ct_display clear">
                        <form name="form_create_session" id="form_create_session" method="post" action="" enctype="multipart/form-data">
                            ...
                            <div class="add_question_wrap clear fullwidth">
                                <p>
                                    ...
                                    <select name="virtual_board" id="virtual_board" class="textbox">
                                        <?php  
                                            ...
                                            foreach ($Arrvirtual_board as $key => $value) {                                   
                                        ?>
                                ...
                                <p>
                                    ...
                                    <label for="question_public">
                                        Is Test Intervention <em>(if checked, automatically assigned to Test tutor)</em>
                                    </label>
                                </p>
                            ...
                            <div style="display: none;" class="add_question_wrap clear fullwidth">
                                ...
                                <div id="Newrow_room_id">
                                    <select name="newrow_room_url" id="newrow_room_url" class="required textbox">
                            ...
                            <div class="add_question_wrap clear fullwidth" style="display: none;">                               
                                <p>
                                    <label for="lesson_name">Choose Teacher:</label>
                                    <div id="teacher_div">
                                        Select Teacher.
                                    </div>
                                </p>
                            ...
                            <div class="add_question_wrap clear fullwidth">                               
                                <p>
                                    <label for="lesson_name">Choose class:</label>
                                    <div id="classes_div">
                                        Select class.
                                    </div>
                                </p>
                            ...
                            <div class="add_question_wrap clear fullwidth">
                                <div id="">
                                    <label for="lesson_name">Choose (1-<?php echo $totalStudentLimit; ?>)students:</label>
                                    <div id="student_div">
                            ...
                            <div class="add_question_wrap clear fullwidth">
                                <div class="row" id="add_more">
                                    ...
                                    <div class="col-md-6" id="time_section">
                                        <label class="col-md-12" for="date">Start Time:</label>
                            
                                        <select class="col-md-4" name="hour[]"  id="time" class="textbox">
                                            <?php
                                                $i = 1;
                                                while ($i <= 12) {
                                        ...
                                        <select  class="col-md-4" name="minnute[]"  class="textbox">
                                            <?php
                                                $k = 0;
                                                while ($k <= 55) {
                                        ...
                                        <select  class="col-md-4" name="hr_type[]"  class="textbox">
                                            <?php
                                                $tArr = array('am', 'pm');
                                                foreach ($tArr as $val) {
                                    ...
                                    <div class="col-md-10" id="lesson_div">
                                        <p>
                                            ...
                                            <select name="lesson[]" id="lesson" class="textbox">
                                                ...
                                                <?php 
                                                    $lesson_query=mysql_query("select name, file_name, url from master_lessons order by name asc");
                            ...
                            <p class="align-right" style=" text-align: right;">
                                <a class="btn btn-primary btn-sm" name="add" id="add" >
                                    <i class="fa fa-plus-circle" >+Add More</i>
                                </a>
                            </p>
                            <p>
                                <button type="submit" name="create_submit"                                
                                    id="lesson_submit_id" class="form_button" 
...
var dateToday = new Date();
        ...
        $("#form_create_session").submit(function() {
            //event.preventDefault();
            var tot_students = $("#students_id :selected").length;
            if (tot_students < 1 || tot_students > <?php echo $totalStudentLimit; ?>) {
                alert(tot_students + ' Students, choose between (1-<?php echo $totalStudentLimit; ?>) students!');  
                return false;
            } else {  
