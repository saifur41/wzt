...
//student incomplete quiz for completed session: in_process :: In Progress // $studentId=10748; 
 ...
 //echo '<br><br>student id = '.$studentId.'<br><br>';
...
if ($student_school == 130){
  $sql="SELECT sd.quiz_status,sd.completion_date,sd.student_id,ses.* FROM int_schools_x_sessions_log ses INNER JOIN int_slots_x_student_teacher sd ON sd.slot_id =ses.id WHERE sd.student_id='$studentId' and sd.slot_id > 5314 order by sd.slot_id desc limit 2 ";   
}
