...
/* this is Login Script for Telpas Dsahborad*/
...
<div id="home main" class="clear fullwidth tab-pane fade in active">
    <div class="container">
      <div id="items_id" style="display: none;">
        ...
        <div class="row">
          ...
          <div class="ct_heading clear" style="text-align: left;"><h3>Welcome</h3>
          </div>    <!-- /.ct_heading -->
        ...
        <a href="#">Welcome <?=(!empty($_SESSION['student_name']))?$_SESSION['student_name']:''?></a>
              </h3>                                    
            </div>
          </div>
   ...
   <?php 
      ...
      if($total_ses>0&&isset($stop_this)){
     ?>
     ...
     $grade=mysql_fetch_assoc(mysql_query(" SELECT name FROM terms WHERE id='".$row['grade_id']."' "));    
        $grade=($row['grade_id']>0)?$grade['name']:"NA";?>
           ...
           <tr>
                <td>
                <span>  <strong>Session ID: </strong><?=$row['id']?> <br> </span><span>
