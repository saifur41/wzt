...
//    unset($_POST['password']);
    //print_r($_POST);
    mysql_query("UPDATE students SET first_name = \"" . $first_name . "\", last_name = \"" . $last_name . "\", username = \"" . $username . "\", password = \"" . $passowrd . "\" WHERE `id` = {$_GET['sid']}  ");
    $error = 'Details has been updated successfully.';
}

 $str="SELECT first_name,last_name,username,password FROM students WHERE id=" . $_GET['sid'];
...
<?php if ($error != '') echo "alert('{$error}')"; ?></script>
