...
tr.shown td.details-control {
  ...
  <div class="panel-heading">
      <div class="ct_heading clear" style='background-color: #f5f5f5 !important'>
           ...
           <a href="<?=$_SERVER['PHP_SELF']?>" target="_blank"  title="Recent created Tutoring Sessions" 
   ...
   $stud_str[]=$row2['first_name'].' '.$row2['middle_name'].' '.$row2['last_name'];
       ...
       $lesson=mysql_fetch_assoc(mysql_query("SELECT id,name FROM `master_lessons` WHERE id='".$row['lesson_id']."' "));
          ...
          ?>
            ...
            <td>incomplete</td>
            <td>
                <a href="intervention_det.php?ses_id=5446" class="btn btn-success btn-sm" style="padding: 3px 5px !important;">View</a>&nbsp;&nbsp;<a style="padding: 3px 5px !important;" href="edit_session.php?sid=5446" class="btn btn-info btn-sm">Edit</a>
