...
$to="mshah@intervene.io"; 
 $mail = new PHPMailer;
    // Set who the message is to be sent from
    $mail->setFrom('mshah@intervene.io', 'Intervene Feedback');
    // Set an alternative reply-to address
    $mail->addReplyTo('mshah@intervene.io', 'Intervene Feedback');
    // Set who the message is to be sent to
    $mail->addAddress($to, '');
    $mail->AddCC("amccloud@intervene.io", '');
    $mail->addBCC('omar@intervene.io');
    $mail->addBCC('csmith@intervene.io'); 
    // Set the subject line
