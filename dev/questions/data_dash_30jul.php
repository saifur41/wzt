...
GROUP BY s_x_s.student_id');
    ...
    $total_mis = 0;
    $res = mysql_query('SELECT count(DISTINCT s_x_a.student_id) as cnt, s_x_a.distractor, d.name FROM students_x_assesments s_x_a '
    ...
    while ($mis = mysql_fetch_assoc($res)) {
        ...
        $mis_num = mysql_query('SELECT s_x_a.num, t.obj_short FROM students_x_assesments s_x_a '
                . 'INNER JOIN distrators d ON s_x_a.distractor = d.id '
...
// default
  $sql="SELECT COUNT(distractor), distractor, student_id FROM students_x_assesments WHERE distractor > 0 "
...
<html>
    <head>
        <title>Teacher Data Dash &trade;</title>
...
<?php } ?>
   ...
   <tr class="">
    <td style="border:0px;height:50px;font-weight: bold; font-size: 30px;" colspan="2" align="center"><p style="margin-bottom: 55px;">Teacher Data Dash <sup>TM</sup></p></td></tr>
    </thead> 
...
//      <pagebreak /> ';
   ...
   // $html.='<div style="page-break-before:always"></div>';
    ...
    $html.='<table id="tab2"; style="border:0px !important; width:100%;margin: 60px 0px 0px;"><tr>';
            if (count($misconception_result) > 0) {
                $html.='<td  valign="top"> <table style="border:0px !important;" width="100%"><tbody><tr>
                    ...
                    <table style="border:0px !important; width:100%;">
                        ...
                        <tr>
                            ...
                            <tr>
                                ...
                                <td style="border-left:0px !important; font-size: 12px;width:30px;">% inccorect</td>
                                <td style="border-left:0px !important; font-size: 12px; border-right:0px !important;">Misconception</td>
                            </tr>';
