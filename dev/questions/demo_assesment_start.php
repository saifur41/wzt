<?php include("demostudent_header.php"); ?>
<?php
// student_header
...
mysql_query('UPDATE demo_teacher_x_assesments_x_students SET status = "In Progress" WHERE '
...
if($_POST['complete']) {
mysql_query('UPDATE demo_teacher_x_assesments_x_students SET status = "Completed" , completion_date = \''.$created.'\' WHERE '
        . 'student_id = \'' . $_SESSION['student_id'] . '\' AND '
        . 'teacher_id = \'' . $_SESSION['teacher_id'] . '\' AND '
        . 'assessment_id = \''.$assesment_id.'\' ');
$_SESSION = array();
...
if ($_POST['next']) {
    ...
    mysql_query('DELETE FROM demo_students_x_assesments WHERE student_id = \'' . $student_id . '\'  AND qn_id = \'' . $given_qn . '\'  AND assessment_id = \'' . $assesment_id . '\' AND teacher_id = \'' . $teacher_id . '\' ');
	
    mysql_query('INSERT INTO demo_students_x_assesments SET '
    ...
    header('Location: demo_assesment_start.php?pos=' . $next);
    exit;
    }else{
...
$stored_res = mysql_query('SELECT * FROM demo_students_x_assesments WHERE '
                        ...
                        <form method="post">
                            ...
                            <li style="border: none;list-style:none;">
                                        ...
                                        <div class="ques-button" style="border: none; ">
                                            ...
                                            <?php if ($prev != -1) { ?>
                                            <a href="demo_assesment_start.php?pos=<?php print $prev; ?>" class="form_button submit_button" style="background: red;display:inline-block; width: 50px; "  >Back</a>
                                            <?php } ?>
                                ...
                                ?>
                                    ...
                                    <a href="demo_assesment_start.php" class="form_button submit_button"  style="background: red;padding: 5px;"  >Go Back and Check Work</a>
                                     <br/><br/>
