							...
							<div class="add_question_wrap clear fullwidth">
								...
								?>
									<li>
										...
										<input type="radio" name="correct" class="hidden_field radio_check" value="<?php echo $i; ?>" <?php echo $checked; ?> />
										<textarea name="answers[]" class="answers_no_spanis no_spanis_<?php echo $i; ?>" 
										placeholder="Answer here..."><?php echo $dataTxt; ?></textarea>
...
<script type="text/javascript" src="js/form-new-validation.js"></script>
