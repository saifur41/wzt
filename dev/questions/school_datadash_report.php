...
/////////////////////////
    function sort_overall(ascending, columnClassName, tableId) {
    var tbody = document.getElementById(tableId).getElementsByTagName(
        "tbody")[0];
    var rows = tbody.getElementsByTagName("tr");
    var unsorted = true;
    while (unsorted) {
      ...
      for (var r = 0; r < rows.length - 1; r++) {
        ...
        var nextValue = nextRow.getElementsByTagName("TD")[5].innerHTML;
  ...
  /////////////////////
  function sort_obj(ascending, columnClassName, tableId) {
     console.log('sort_obj sor ==');
    var tbody = document.getElementById(tableId).getElementsByTagName(
        "tbody")[0];
    var rows = tbody.getElementsByTagName("tr");
    var unsorted = true;
    while (unsorted) {
      ...
      for (var r = 0; r < rows.length - 1; r++) {
        ...
        ////////
        // x = rows[i].getElementsByTagName("TD")[col_number];
         var value = row.getElementsByTagName("TD")[6].innerHTML;
        var nextValue = nextRow.getElementsByTagName("TD")[6].innerHTML;
  ...
  ////////Select Assesment////
                             ...
                             //   alert('d'); objectives_id
                             $('#filter_section').html('');
                              $('#domain_id option').attr('selected', false);
                              //objective old uncheck
                              $("#objectives_id option:selected").each(function(){
                      $(this).removeAttr("selected");
                              });


                             // $('#objectives_id option').attr('selected', false);
...
if($_POST['select_type']=="doamin"&&!empty($get_domain)){
  ...
  $filter_column.='<span class="text-info">'.$get_domain.'</span>';
...
IN ( ".$objectives_str1." ) ");
  ...
  $filter_column.='<span class="text-info">'.implode(",", $obj_names).'</span>';
...
GROUP BY sa.assessment_id");
                 ...
                 <select name="assesment" id="assesment_id" class="required textbox"   >
 ...
 <th class="arranger">Student ID</th>
      ...
      <th class="arranger">Assessment</th>
       ...
       <th class="set">Overall Score %
        <div class="sort-table-arrows">
          <a href="javascript:sort_overall(true, 'set', 'content-table3');"><button class="button" ><i class="fa fa-chevron-down"></i></button></a>
          <a href="javascript:sort_overall(false, 'set', 'content-table3');"><button class="button"><i class="fa fa-chevron-up"></i></button></a>
        </div>
      </th>
        ...
        <div class="sort-table-arrows">
          <a href="javascript:sort_obj(true, 'set', 'content-table3');"><button class="button" ><i class="fa fa-chevron-down"></i></button></a>
          <a href="javascript:sort_obj(false, 'set', 'content-table3');"><button class="button"><i class="fa fa-chevron-up"></i></button></a>
        </div>
      </th>
  ...
  <tbody>
      ...
      <td data-label="Arranger"><?=$arr['assessments']?></td>
       ...
       <td data-label="Arranger"><?=intval(round($arr['overall']))?></td>
