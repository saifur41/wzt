...
if($_POST) {
    ...
    $res = mysql_query('SELECT first_name, middle_name, last_name, username, password, dob FROM demo_students WHERE '
    ...
    $class_result = mysql_fetch_assoc(mysql_query('SELECT * FROM demo_classes WHERE id = \'' . $class_id . '\' '));
...
$res = mysql_query('SELECT * FROM demo_classes WHERE teacher_id = \'' . $user_id . '\' ');
