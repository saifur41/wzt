...
$Spanish_questionList=" SELECT id,question_spanish FROM `questions` q WHERE q.`passage`=0 AND name_spanish!='' AND question_spanish!='' AND answers_spanish!=''
AND question_spanish!= '<p>&nbsp;&nbsp;</p>';
 ";
...
function _removeEmptyPTags($new_str){

	$new_str= preg_replace("/<p[^>]*>[\s|&nbsp;]*<\/p>/", '', $str);
...
/////////////////////////////////////////
	...
	if($question_type == 1||$question_type=='1'){
		...
		$answer_data_spanish = mysql_real_escape_string($_POST['response_answer_spanish']);
         ...
         // echo  'data -=='; var_dump($question_question_spanish); 
          $question_question_spanish=(!empty($question_question_spanish))?$question_question_spanish:''; //NULL, ''

          $question_name_spanish=_removeEmptyPTags($question_name_spanish);

           $question_name_spanish=(!empty($question_name_spanish))?$question_name_spanish:NULL; //NULL, ''

           //echo '=='.$question_question_spanish;  die; 
	...
	if($question_id ==0) {		# Insert
       ...
       // Validate  :: name_spanish , question_spanish , answers_spanish
