...
include("header.php");
/****
@ SELECT * FROM int_schools_x_sessions_log WHERE 1 AND type='homework' AND is_drhomework='no' ORDER BY ses_start_time DESC.
...
$AllowSessionType='homework'; // SchoolCreated Session
			...
			<div id="content" class="col-md-8">
				...
				<form id="form-manager" class="content_wrap" action="" method="post">
					<div class="ct_heading clear">
						<h3>Manager Homework Help Sessions(<?=$tot_record?>)</h3>
            &nbsp;&nbsp;&nbsp;&nbsp;
         ...
         //// list of students 
          ...
          ?>
                    ...
                    <?=date_format(date_create($row['ses_start_time']), 'h:i a');?></span> 
                                 ...
                                 <strong class="text-primary">
                                 Class list of students:</strong>[NA<?php  // =$stdList?>]
                                <br/>
