<?php
/****
 * School:: Questions List
 *  iff : passage>0 , then -school able to select question otherwise not , 
 * ****/
//echo 'School::Question List';  //
...
<div id="folder_wrap" class="content_wrap">
	<div class="ct_heading clear">
		<h3><?php echo $title; ?></h3>
                <a href="school_assessment_step3.php" 
                   class="btn btn-danger btn-sm" style="float: right; margin-left: 10px;margin-top: 5px;">Next</a>
<!--		<ul>
			...
			while( $item = mysql_fetch_assoc($childs) ) {
				...
				if( $item['type'] == 1 ) {
					...
					foreach( $answers as $key => $answer ) {
						...
						$echo .= '<p>' . strip_tags($answer['answer']) . '</p>';
...
<a href="school_assessment_step3.php" class="btn btn-danger btn-sm" style="float: right; margin:9px;">Next</a>
