...
$query = mysql_query("SELECT `id` FROM `distrators`");		# Count total of records
...
$childs = mysql_query("SELECT * FROM `distrators`" . $limit);
?>
	...
	<div class="ct_display no_padding clear">
		...
		?>
				<div class="item-listing clear<?php echo $line; ?>">
					...
					<a href="javascript: void(0);" class="item_name"><?php echo $item['name']; ?></a>
				</div>
		<?php
				$i++;
			}
