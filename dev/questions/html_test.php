<html>
  ...
  <div class="container">
    ...
    <div class="row-fluid">
      <select id="selectdate" multiple="" class="selectpicker" data-show-subtext="true" data-live-search="true">
  ...
  <script type="text/javascript">
      $(document).ready(function(){$("#selectdate").chosen().change(function(){
       alert('sdd');
        //var id = $(this).val();
    });
  });
