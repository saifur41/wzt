              ...
              while($line = fgetcsv($handle, 1000, ",")){
                ...
                if($d >= 1) {
                    ...
                    /*check grade is gratjer then 8*/
                        ...
                        $classname=$line[8];
                        $class_code =$line[9];
                        $teacher_first_name =$line[11];
                        $teacher_last_name =$line[12];
                        $teacher_email =$line[13];
                        $Tuname=$teacher_last_name.'123';
                        $teacher_unique_id =$line[14];;
                        $Tpass=md5(123456);
...
echo '<script>window.location="add_new_roster_spring.php"</script>';
   }
   ?>
                        ...
                        <tbody>
                           <?php
                              ...
                              <td align="center">
                                ...
                                <a href="add_new_roster_spring.php?delid=<?= $res['id']?>" style="color: red"onclick="return confirm('Are you sure?')"><i class="fa fa-trash"></i></a>
                              </td>
                            </tr>
                           <?php 
                              $i++; } ?>
