...
<div class="group_1 widget-content">
    ...
    <div id="arrange" class="widget clear fullwith">
	<h4 class="widget-title"><i class="fa fa-file-text-o"></i><a href="https://intervene.io/Data Dash Instructions.pdf">How Data Dash Works</a></h4>
</div>	
...
<!--<div id="" class="widget clear fullwith" title="Manage tutor Sessions">
	<h4 class="widget-title"><i class="fa fa-file-text-o"></i><a href="teacher-tutor-sessions.php">Manage tutor Sessions</a></h4>
</div>
...
<div id="howitworks" class="widget clear fullwith">
 ...
 <!---Tutor session p---
 Schedule Tutor Sessions :: go to Map calendar's
 
 --->
<div id="datadashw" class="widget clear fullwith">
	<h4 class="widget-title"><i class="fa fa-file-text-o"></i><a href="#">Online Tutorials / Interventions</a></h4>
</div>	
<div class="group_1 widget-content">
	...
	<h4 class="widget-title"><i class="fa fa-file-text-o"></i>
            <a href="teacher-tutor-sessions.php">Schedule Tutor Sessions</a></h4>
        </div>
    <div id="arrange" class="widget clear fullwith"  title="Calendar View">
        
	<h4 class="widget-title"><i class="fa fa-file-text-o"></i>
            <a href="teacher-sessions-calendar.php">Calendar View</a></h4>
        </div>
	...
	<h4 class="widget-title"><i class="fa fa-file-text-o"></i>
            <a href="https://intervene.io/Online Tutoring - Intervention Instructions.pdf">How it works - Tutorial Instructions</a></h4>
        </div>
    
    
<!--    <div id="arrange" class="widget clear fullwith" title="Results & Student Growth">
	<h4 class="widget-title"><i class="fa fa-file-text-o"></i>
            <a href="#">Results & Student Growth</a></h4>
         </div>-->
