...
<html lang="en-US">
    ...
    <body data-spy="scroll" data-target=".inner-link" data-offset="60">
        <main>
            ...
            <section class="background-success py-3 d-none d-sm-block">
                <div class="container">
            ...
            <div class="znav-white znav-container sticky-top navbar-elixir" id="znav-container">
                <div class="container">
                        ...
                        <a class="navbar-brand overflow-hidden pr-3" href="index.php">
                            <img src="assets/images/smartplayslogo.png" alt="Logo" style="height:40px" />
                        </a>
                                ...
                                <li>
                                    ...
                                    <ul class="dropdown fs--1">
										...
										<li>
											...
											<li>
                                            <a href="smartprep.php">SmartPrep - STAAR Question Database</a>
                                        </li>
