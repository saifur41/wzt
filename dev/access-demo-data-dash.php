...
if (isset($_POST['get_access'])){
   ...
   // print_r($_POST); die;
    ...
    $schoolInsert = mysql_query("INSERT INTO `demo_users` (`email`, `password`, `first_name`, `last_name`, `district_id`, `school_id`, `master_school_id`, `phone_number`, `role`, `other_district`, `other_school`, `expiry_date`, `data_dash`,`active_code`)
                 VALUES ('$email','$password', '$first_name', '$last_name', '$district_id', '$school', 1, '$phone_number', '$role', '$district_name', '$school_name', '$expiry_date', '$data_dash', '$code')");
         


   $user_id= $userId = mysql_insert_id();
    require_once('./questions/inc/email_data_dash.php');// SendEmail
  ...
  <br /><br />
        ...
        <br />
        5. Check out the results on your Data Dash by clicking Results-Dashboard and Detailed Reports!!
        <br /><br />
