...
require_once('header.php');
  ...
  // echo '==========access-demo-smart-prep.php';
...
if (isset($_POST['get_access'])){
   ...
   //////////////////////////
    ...
    $code = substr( md5(rand()), 0, 10); // mysql_query
    $schoolInsert =mysql_query("INSERT INTO `demo_users` (`email`, `password`, `first_name`, `last_name`, `district_id`, `school_id`, `master_school_id`, `phone_number`, `role`, `other_district`, `other_school`, `expiry_date`,`smart_prep`,`active_code`)
                 VALUES ('$email','$password', '$first_name', '$last_name', '$district_id', '$school', 1, '$phone_number', '$role', '$district_name', '$school_name', '$expiry_date',  '$smart_prep', '$code')");

           // echo '<pre>';
      // echo  $schoolInsert; die;



    //////////////////////////
   $user_id= $userId = mysql_insert_id();
    require_once('./questions/inc/email_smart_prep.php');// 
  ...
  if(!$check_code){
    ...
    $firstname=$_POST['firstname'];
     $active_user_url ='https://intervene.io/questions/demo-active-user.php?code='.$code;
  ...
  <br /><br />
        ...
        <br /><br />
        1. Choose a folder and grade level to preview questions 
        <br />
        2. Arrange Questions
        <br />
        3. Click Save and Print
        <br />
        4. A PDF will download to your computer
        <br />
        5. You can print the questions and follow instructional document on page 1.
        <br /><br />
  ...
  <br />
        ...
        <br /><br />
        Please save this URL for future demo logins: 
        <br/>
       <a href=' https://intervene.io/questions/demo_login.php'> https://intervene.io/questions/demo_login.php</a>

         <br/>


        You have 14 days of full access to our products. If you have any questions, feel
        <br />
        free to contact us at learn@intervene.io. We’re here to help.
        <br /><br />
  Best regards,<br />
  ...
  <br /><br />
        ...
        <br /><br />
  <img style=' height: 40px;'  alt='Intervene' src='https://intervene.io/questions/images/logo.png'>";
     ...
     // echo     '<br/> <br/><br/><br/>' ,$message; 
      ...
      //  iform to user .   function sendEmailToActive($user_id,$msg_body,$to_email){
     //sendEmailToActive($userId,$message);
        $to_email=$user_info['email'];

    if(sendEmailToActive($userId,$message,$to_email)){
      $info='notice send to Demo user';
    }else{
      $info='Error in Email Sending';
    }
    ...
    $_SESSION['temp_data_dash'] ='';
    
   $send_notice=sendNoticeToAdmin($first_name, $last_name,$school_mail_name,$dist_mail_name,$role_name);
		...
		<div class="col-lg-8 col-md-8 col-md-12 col-md-12">
			...
			<form id="checkout" method="POST" action="">
				<div class="form-group">
					...
					<select name="state" class="textid" id="state" class="form-control required">
          ...
          <br><br>
				...
				<div class="form-group">
					<label for="title">Title / Role</label> <br>
					<select name="role" id="title" class="textid" class="form-control required">
          ...
          <br><br>
					<small class="error text-danger">Please enter your title!</small> <br>
				</div>
				<div class="form-group">
	...
	$(document).ready(function(){
      ...
      /////////////////////////////////
		...
		$('#checkout').on('submit', function(event){
			...
			// 	if( $(this).is(':checked') )
			// 		counter++;
			// 	console.log('check selected Folder');
			// });
