...
<html lang="en-US">
    ...
    <head>
        ...
        <link href="assets/lib/bootstrap-4/dist/css/bootstrap.min.css" rel="stylesheet">
				...
				<div class="container">
					...
					<div class="top-secondary-menu">
						  ...
						  <ul class="top-menu">
							...
							<li class="top-text"><a>Intervene is supporting online instruction due to school closures caused by Coronavirus (COVID-19)</a></li>

							<li class="top-text"><a href="https://zfrmz.com/HXaTJPNZwNuUuojOHLFm" target="_blank" class="top-links">Assistance for School Districts</a></li>

							<li class="top-text"><a href="https://drhomework.com/getstarted/" target="_blank" class="top-links">Assistance for Parents</a></li>
                ...
                <div class="container">
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-auto">
                            ...
                            <a class="ml-2 mb-0 fs--1 d-inline color-white fw-700" href="https://zfrmz.com/t2LK7TRo97WwldFtcu5E">TASA Midwinter</a>
                        ...
                        <div class="collapse navbar-collapse" id="navbarNavDropdown">
                            ...
                            <ul class="navbar-nav fs-0 fw-700">
                                ...
                                <li>
                                    ...
                                    <a  href="https://forms.zohopublic.com/intervene/form/BookDemo/formperma/tnusr1H4WiqMi7dt43ImixpYYej9gVueFlX0eviLktA">Contact Us</a>
                                    ...
                                    <a href='https://forms.zohopublic.com/intervene/form/BookDemo/formperma/tnusr1H4WiqMi7dt43ImixpYYej9gVueFlX0eviLktA' title="Contact Us & Schedule Consultation" target='_blank' onclick="zforms_open_window(this.href, 648, 700); return false">Contact Us</a>
                                ...
                                <li>
                                    ...
                                    <a href="https://www.intervene.io/support.php">Support</a>
...
-->                        	
                                ...
                                <li>
                                    ...
                                    <a class="btn btn-outline-primary btn-capsule btn-md border-2x fw-700" href="questions/login.php" target="_blank">Log In</a>
