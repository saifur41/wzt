	...
	<div class="container">
		<div class="row">
			...
			<div id="content" class="col-md-8">
                            ...
                            <div class="table-responsive">
                                <?php
                                //action=Search
                                $qq=" SELECT * FROM int_schools_x_sessions_log WHERE tut_status='STU_ASSIGNED' ";
		...
		<input type="checkbox" class="checkbox" value="<?php echo $row['id'];?>"/>
				...
				<td>
                                ...
                                Date:</strong>
                                        <?=$Sesdate=date_format(date_create($row['ses_start_time']), 'd/m/Y');?><br/>
                                    </span>  
                     ...
                     <?=$SesTime=date_format(date_create($row['ses_start_time']), 'H:i a');#?>
                               <br/>
                                 ...
                                 To:</strong>   
                                  ...
                                  <?=date_format(date_create($row['ses_end_time']), 'H:i a');#?>
                                 </span>    
