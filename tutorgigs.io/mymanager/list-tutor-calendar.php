			...
			<div id="content" class="col-md-8">
                            ...
                            <div class="table-responsive">
                              ...
                              // All slot -student had Assiened
                                ...
                                // $date = DateTime::createFromFormat('d/m/Y',$_GET['sdate']);#24/04/2018
                                    //$dd= $date->format('Y-m-d');
                                    $dd=$sdate; $enddate=$dd." 23:59:59.999";
                                 
                                 $fd=" AND slot_date_time>='$dd' AND slot_date_time<='$enddate' ";
                                 $qq.=$fd;
                               ...
                               //  echo $qq;
                                ...
                                <form id="search-users" method="post" action=""  >
						<table class="table">
							<tbody><tr>
								<td><label>Search:</label></td>
				<td><input name="sdate" class="form-control" placeholder="Date"
                                           value="<?=$_POST['sdate']?>" type="date"></td>
                              ...
                              <span class="btn btn-primary btn-xs"><?=$tot_std ?>-<?=$status_arr['STU_ASSIGNED']?></span>
                                 ...
                                 <!-- <br/><a>App Url-https://www.youtube.com/</a>--->
                                  ...
                                  <a href="javascript:void(0);"  class="text-danger"
                                   onclick="sent_form('assign_a_teacher.php', {getid:'<?=$row[id]?>',productname:'101',detail:'this is a text.'});"
                                   style="text-decoration:underline;">Re-assign teacher</a> 
                                      <?php }else{?>
                                  <span class="btn btn-danger btn-xs"><?=$status_arr['SES_NOT_ASSIGNED']?></span>
                                   ...
                                   style="text-decoration:underline;">Assign teacher</a> 
                                    ...
                                    <a href="javascript:void(0);" 
                                   onclick="sent_form('session-detail.php', {getid:'<?=$row[id]?>',productname:'201',detail:'this is a text.'});"
