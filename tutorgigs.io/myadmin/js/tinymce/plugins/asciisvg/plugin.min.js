	...
	tinymce.create('tinymce.plugins.AsciisvgPlugin', {
		...
		init : function(ed, url) {
			...
			ed.addButton('asciisvg', {
				...
				stateSelector: 'img[data-asciisvg]'
			});
				...
				var imgs = o.content.match(/<embed[^>]*sscr[^>]*>/gi);
					if (imgs != null) {
						for (var i=0; i<imgs.length; i++) {
							...
							rep = '<img src="'+ed.getParam('AScgiloc')+'?sscr='+encodeURIComponent(sscr)+'" style="'+style+'" sscr="'+decodeURIComponent(sscr)+'" data-asciisvg="1" />';
							o.content = o.content.replace(imgs[i],rep);
						}
					}
			});
		...
		getInfo : function() {
			return {
				...
				author : 'David Lippman',
				authorurl : 'http://dlippman.imathas.com',
				infourl : '',
				version : "4.0"
			};
		}, 
