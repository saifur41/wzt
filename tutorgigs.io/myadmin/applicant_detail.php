...
<div class="col-md-12"> <a href="pdf_applicant_download.php?tid=<?php echo $_GET['tid'];?>" class="btn btn-success" style="float:right;margin-bottom: 7px;margin-top: 7px">Download PDF</a></div>
