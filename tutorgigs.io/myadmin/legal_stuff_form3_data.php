		...
		<div class="row">
					...
					<div class="wizard-v3-content">
						<div class="wizard-form">
							<div class="wizard-header">
								<h3 class="heading">Legal Stuff W-9 information</h3>
         ...
         //                            $(".multiple-input").keyup(function () {
									...
									$getid=$_GET['tid'];
									 ...
									 $form_3=unserialize($profile['legal_form3_data']);

                                        //echo '<pre>'; print_r($form_3);
														 ...
														 <div class="col-md-11">
														    <div class="tax-form-form">
															     <div class="form-group">
																	...
																	<input type="text" name="name_income_tax" required="" placeholder="name" class="form-control-2" id="email">
																  </div>
																  <?php  
													  $form_3['business_name']=(!empty($form_3['business_name']))?$form_3['business_name']:'NA';
																  ...
																  <div class="form-group">
																	...
																	<input type="text" name="business_name" value="<?=$form_3['business_name'];?>" 
																	 required placeholder="Business name" class="form-control-2" id="pwd">
																  </div>
