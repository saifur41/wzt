                    ...
                    &nbsp;<input name="action" class="btn" value="Search" type="submit">    
								...
								<div class="ct_heading clear">
						             <h3><?=$page_name?>(<?php echo  $tot_record; ?> Sessions) - <?php echo  $tot_record; ?> Total Hours</h3>
										<ul>
                      <li style="color: black"> Custom Pay Amt: 
                        <input id="custom_session_pay_amount" value="<?php echo $custom_session_pay_amount ?>" class="form-control" style="color: black;  display:inline; width: 60px;">
                      </li>
                    <li>					  
