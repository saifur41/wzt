        ...
        $lesson_download="https://intervene.io/questions/uploads/lesson/".$lesson_det['file_name'];// 4358Question.pdf.
          ...
          ?>
                    ...
                    <?=date_format(date_create($row['ses_start_time']), 'h:i a');?></a> 
                                    <br/>
                                  <span style="font-size:15px"><strong class="text-primary">Lesson:</strong><?=$lesson_det['name'];?> </span>
                                  <br>
              ...
              <?php $mod_url="moderator_join_room.php?sesid=".$row['id']; ?>
                            ...
                            <td>
                              <a  class="btn btn-danger btn-xs viewSession" 
                                ...
                                SessionID="<?=$row['id']?>"  
                                action="<?=$Sessiontype?>">See Details
                              </a>
                              <br/>
                              <br/>
                                    <div class="dropdown">
                            ...
                            <span class="btn btn-danger btn-xs"><?=$status_arr['SES_NOT_ASSIGNED']?></span>
                               ...
                               <a href="javascript:void(0);" 
                                   ...
                                   <?php 
                                                            if($row['add_observer'])
                                                            {
                                                               echo '<span class="btn btn-info btn-xs" style="margin-top:8px">Observer</span>';
                                                            }
                                                            else 
                                                                echo '<span class="btn btn-primary btn-xs" style="margin-top:8px">Tutor</span>';   
                                                    ?>
