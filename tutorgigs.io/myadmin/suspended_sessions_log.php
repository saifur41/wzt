...
$page_name="Suspended Sessions by-Admin";
         ...
         if(isset($_GET['action'])&&$_GET['action']=="Filter")
          {
            ...
            $sql="SELECT sn.*,ins.* FROM int_session_suspend_cancelled_log sn 
LEFT JOIN int_schools_x_sessions_log ins
ON sn.tutoring_id=ins.id
            WHERE 1   
ORDER BY sn.ID DESC";
                           ...
                           <table class="table-manager-user col-md-12">
                              ...
                              <?php
                                 if( mysql_num_rows($results) > 0 ) {
                                  ...
                                  $str="SELECT * FROM `gig_teachers` 
                                  WHERE id='".$row['tutor_id']."'";
                                  $r=mysql_query($str);
                              ...
                              <tr>
                                 ...
                                 <td>
                                    ...
                                    <strong class="text-primary">
                                      Tutoring ID-
                                    </strong> <?=$row['tutoring_id']?>

                                 </td>
                                 <td >
                                    <strong class="text-primary">
                                    Cancelled for Tutor:</strong><?php echo $Tutor['f_name']." ".$Tutor['lname'];?><br/> 
                                    <strong class="text-primary">
                                      Cancelled at-
