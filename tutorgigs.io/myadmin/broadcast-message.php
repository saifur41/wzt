...
function send_a_email($email,$to,$message,$f_name='',$subject)
{
...
if(send_a_email($from_email,$to=$to_email,$msg_text,$f_name,$subject)){
            ...
            <div id="content" class="col-md-8">
             ...
             <form name="form_class" id="form_class" method="post"  enctype="multipart/form-data">
                      ...
                      <div class=""> 
                           <?php  if(isset($error)&&!empty($error)){?>
                            <div class="profile-item alert alert-info text-left"><?=$error;?></div> <?php }?>  
                          </div>
               ...
               <div class="add_question_wrap clear fullwidth"style="display:inline-block;">
                 <?php
                        if(isset($_POST['tutor']))
                        $st_arr=$_POST['tutor'];
                        $sql=" SELECT * FROM `gig_teachers` WHERE 1 AND all_state='yes' ";
             ...
             <div class="left col-md-6">
                ...
                <label for="smart_prep" style="font-weight:bold;"><?=$tutor_name.'&nbsp;('.$user.')'?></label>
                          ...
                          <div id="subject" style="display: block"> 
                                   <textarea class="form-text" required name="subject" placeholder="Your subject" id="subject"><?=$_POST["subject"] ?></textarea>   
                                </div> 
