 ...
 * @ adhoc Tutor
 * 
 * @ assign_a_tutor :: assign Tutor in Session
 * 
 * 
                ...
                $stud_str[]=$row['first_name'];
								...
								<tbody>
                                               ...
                                               ?>                 
                                                                ...
                                                                <td>
                                                                 <?=$sdate?> <strong>at-</strong><?=$at_time?>
                                                                 </td> 
                                                                 </tr>
                                 ...
                                 <?php  if(!empty($int_th['first_name'])): ?>                                         
                              <p><span class="text-danger">Teacher Name-</span><?=$int_th['first_name']?></p> <?php endif;?>
                                 <?php if(isset($quiz['objective_name'])){?>
                                <p><span class="text-danger">Objective</span>-
                                <?=$quiz['objective_name']?></p> <?php }?>


                                            <?php if(isset($special_notes)){?>
                                            <p><span 
                                              class="text-danger">Notes-</span> 
                                              <?=$special_notes?></p> <?php }?>
