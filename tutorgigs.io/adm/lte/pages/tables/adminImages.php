            ...
            <aside class="right-side">
                ...
                <section class="content">
                    ...
                    <?php foreach($images as $i){
                    	                    ?>
                    <div class="col-sm-3">
                    <form action="imageStatus.php" method="POST">
                    <input type="hidden" name="tid" value="<?php echo $i->TutorId;?>"/>
                    <div class="row">
                    <div class="col-sm-12">
                    <img src="http://p2g.org/profile/<?php echo $i->Picture;?>"  class="img-thumbnail">
                    </div>
                    
                    </div>
                    <div class="row" style="margin-top:5px">
                    <div class="col-sm-6">
                    <button class="btn btn-success btn-block" type="submit" name="Approve" >Approve</button>
                    </div>
                    <div class="col-sm-6">
                    <button class="btn btn-danger btn-block" type="submit" name="Deny" >Deny</button>
                    </div>
                    </div>
                    </form>
                  <br/>  
