<?php  
    ...
    if(empty($_SESSION['user']) || (int)$_SESSION['user']['Security'] < 90) 
    {
		...
		$result = mysqli_query($connection, "SELECT * FROM categories WHERE IsActive=1");
		$totalActive = $result->num_rows;
		$result = mysqli_query($connection, "SELECT * FROM categories WHERE IsActive=0");
		$totalNotActive = $result->num_rows;
		$categoriesList = mysqli_query($connection, "SELECT 
					*
					FROM
					categories
...
<html>
    <head>
        <meta charset="UTF-8">
        <title>Categories | P2G Admin</title>
                        ...
                        <div class="col-xs-12">
                            <div class="box">
                                    ...
                                    <ul class="nav navbar-nav">
                                        ...
                                        <li class="dropdown messages-menu">
                                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                                ...
                                                <span class="label label-primary"><? echo $totalCategories ?> Total</span>
                                            </a>
                                        ...
                                        <li class="dropdown notifications-menu">
                                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                                <i class="fa fa-book"></i>
                                                <span class="label label-danger"><? echo $totalNotActive ?> InActive</span>
                                            </a>
                                ...
                                <div class="navbar-form">                                
                                    <div class="btn-group">                                    	
                                        <button type="button" class="btn btn-defaul navbar-btn" 
                                                onClick="window.location='subjects.php'" 
                                                title="View Subjects for this Category"
                                                >
                                    ...
                                    <div class="btn-group">                                    	
                                        <button class="btn btn-default navbar-btn" data-toggle="modal" data-target="#myModal">
                                            <span class="glyphicon glyphicon-plus-sign" ></span> Add New Category</button>                                       
                                    </div>                                    
                                </div>
                                ...
                                <div class="box-body table-responsive">                                
                                    <table id="example2" class="table table-responsive table-condensed table-hover">
                                        ...
                                        <tbody>
                                            <?php	
                                                while ( $cRecord = mysqli_fetch_array($categoriesList) ) {
													// Check if record is active, set row color appropriately
                                                    $rowColor = (string)$cRecord['IsActive'] == 1 ? '' : 'danger';
													
													// Count of how many subjects belong to this category
													$result = mysqli_query($connection, "SELECT * FROM subjects WHERE CategoryID=".$cRecord['ID']);
													$subjectCount = $result->num_rows;													
                                            ?>
                                            <tr id="c<?php echo $cRecord['ID'] ?>" class="<?php echo $rowColor;  ?>" style="text-align:left;" > 
                                                
                                                <td id="catName<?php echo $cRecord['ID'] ?>"><?php echo $cRecord['Name'] ?></td>
                                                <td><a href="subjects.php"><?php echo $subjectCount ?></a></td>                                                
                                                <!--<td><?php echo $cRecord['IsActive'] ?></td>-->
                                                <td>
                                                    ...
                                                    <button type="button" 
                                                            ...
                                                            onClick="toggleCategoryActive(<?php echo $cRecord['ID'] ?>);" 
                                            ...
                                            <tr id="edit<?php echo $cRecord['ID'] ?>" class="<?php echo $rowColor;  ?>" style="text-align:left; display:none;" > 
                                                ...
                                                <td><input type="text" id="ecName<?php echo $cRecord['ID'] ?>" value="<?php echo $cRecord['Name'] ?>"></td>
                                                <td><a href="subjects.php"><?php echo $subjectCount ?></a></td>                                                                                                
                                                <td>
                                                	<button type="button" class="btn btn-primary" 
                                                    		onClick="UpdateCategory( <?php echo $cRecord['ID'] ?>, $('#ecName<?php echo $cRecord['ID'] ?>').val() );">
...
<!--        <button class="btn btn-primary btn-lg center-block" data-toggle="modal" data-target="#myModal">pop test</button> -->
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                    	...
                    	<div class="container" style="max-width:500px">
                              <form id="cForm" name="cForm" role="form" action="addCategory.php" method="post">
                                ...
                                <!-- Multiple Radios -->
                                <div class="control-group">
                                  <label class="control-label" for="cIsActive">Shown in Test Screens</label>
        ...
        function deleteCategory (categoryID ) {
            //window.location = "adminfCategories.php?action=deleteCategory&categoryID=" + categoryID ;
        }
        
        function toggleCategoryActive( categoryID ) {
            window.location = "adminfCategories.php?action=toggleCategory&categoryID=" + categoryID ;
        }
        </script>
