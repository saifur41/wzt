                        ...
                        <div class='col-md-12'>
                            <div class='box box-danger'>
                                <div class='box-header'>
                                    <h3 class='box-title'>Contact Us<small></small></h3>
                                    <!-- tools box -->
                                ...
                                <div class='box-body pad'>
                                    <form method="post" action="contactus.php">
                                        <textarea id="contact" name="contact" rows="10" cols="80">
                                            <? 												
												//include($aboutFile);	
												echo $epc->getContent();											
											?>
                                        ...
                                        <input type="submit" class="btn btn-success" value="Update Contact Us">                   
                                    </form>
                                </div>
                            </div><!-- /.box -->
                        </div><!-- /.col-->
