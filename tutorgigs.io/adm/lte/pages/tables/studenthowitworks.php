    ...
    <body class="skin-black">
            ...
            <aside class="right-side">
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">Student How It Works</li>
                    </ol>
                </section>
                        ...
                        <div class='col-md-12'>
                            <div class='box box-danger'>
                                <div class='box-header'>
                                    <h3 class='box-title'>Student How It Works<small></small></h3>
                                    <!-- tools box -->
                                ...
                                <div class='box-body pad'>
                                    <form method="post" action="studenthowitworks.php">
                                        <textarea id="shiw" name="shiw" rows="10" cols="80">
                                            <? 												
												//include($aboutFile);	
												echo $epc->getContent();											
											?>
        ...
        <script type="text/javascript">
            $(function() {
                ...
                var editor = CKEDITOR.replace('shiw',
					{						
						height : '600px'
					}
				);
