                        ...
                        <div class='col-md-12'>
                            <div class='box box-danger'>
                                <div class='box-header'>
                                    <h3 class='box-title'>About Us<small></small></h3>
                                    <!-- tools box -->
                                ...
                                <div class='box-body pad'>
                                    <form method="post" action="aboutus.php">
                                        ...
                                        <input type="submit" class="btn btn-success" value="Update About Us">                   
                                    </form>
                                </div>
                            </div><!-- /.box -->
                        </div><!-- /.col-->
