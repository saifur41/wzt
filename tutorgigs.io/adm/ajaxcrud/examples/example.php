<?php
    ...
    $tblDemo = new ajaxCRUD("Tutor Profile", "tutorsProfiles", "ID", "../");
    ...
    $allowableValues = array("Allowable Value 1", "Allowable Value 2", "Dropdown Value", "CRUD");
	...
	$tblDemo->formatFieldWithFunction('BackgroundCheck', 'makeBlue');
	$tblDemo->formatFieldWithFunction('IsComplete', 'makeBold');
