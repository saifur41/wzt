  ...
  // print_r($_SESSION);
   ...
   INSERT INTO `tutor_profiles` (`tutor_id`, `profile_1`, `info`, `created`) VALUES (NULL, 'dffd', '3', '2019-01-23 00:00:00');
    ...
    if (empty($_POST['grade_levels'])) { //
        // list is empty. // What grade levels do you want to Tutor? 
     $warning[]='Please select a grade level';
   ...
   ///////////////////////
     ...
     if($num==0){
       ...
       //$sql=" INSERT INTO `tutor_profiles` (`tutorid`, `profile_1`, `info`) VALUES ('$tutorid', '$state_str', '3') ";
         ...
         $sql=" INSERT INTO tutor_profiles SET tutorid='$tutorid',profile_1= '$state_str',info='Later',grade_levels='$grade_str',subjects='$subject_str',subjects_other='$text_info_other',photo_id='$image_goes',teacher_certificate = '$teacher_certificate_file',esl_certificate = '$esl_certificate_file',billingual_certificate = '$billingual_certificate_file'";
       ...
       // photo_id
       $sql=" UPDATE tutor_profiles SET profile_1= '$state_str',info='Later',grade_levels='$grade_str',subjects='$subject_str',subjects_other='$text_info_other',photo_id='$image_goes',teacher_certificate = '$teacher_certificate_file,esl_certificate = '$esl_certificate_file',billingual_certificate = '$billingual_certificate_file' WHERE tutorid=".$_SESSION['ses_teacher_id'];
     }
     ...
     // echo $sql;  exit;
      $url_next='application.php';
         $ac=mysql_query($sql);
          ...
          if($is_step_completed==1){
             $Update=mysql_query(" UPDATE `gig_teachers` SET signup_state= '$regis_state_str',all_state_url='$step_2_url' WHERE id=".$_SESSION['ses_teacher_id']);
      ...
      /////////////////////////////////////////////
         // if(is_array($_POST['grade_levels'])&&count($_POST['grade_levels'])){
      ...
      //  echo '===SAVDFD'; die;
       ...
       //echo "<script>alert('".$msg."');location.href='".$step_1_url."';</script>";
                     ...
                     <form id="regForm" action="" method="post" enctype="multipart/form-data">
                        <div class="tab">
                           <div class="inner">
                              ...
                              <?php   unset($_SESSION['warning_msg']);  }  // $_SESSION['success']?>
                              <?php  if(isset($_SESSION['success'])){
                                 // auto re-direct to quiz if Step done
                              ...
                              <div class="alert alert-success"
                                 ...
                                 <a class="btn btn-primary" href="quiz.php">Quiz</a>
                              </div>
                              ...
                              <div class="form-row">
                                 <div class="form-holder form-holder-2">
                                    <label class="form-row-inner">
                                    <input type="radio" 
                                       <?=($edit['is_computer']=='no'||!isset($edit['is_computer']))?'checked':null?> name="is_computer"   value="no" id="radio-r" required>
                                    <span class="label">
                                    No</span>
                                    </label>
                                 </div>
                           ...
                           <div class="inner">
                              ...
                              <div class="form-row">
                                 <div class="form-holder form-holder-2">
                                  ...
                                  <div class="form-holder" id="teacher_certificate"  >
                                    <div class="row"> <div class="col-md-12"><div class="col-sm-4"> Uplaod certification</div><div class="col-sm-6"><input style="font-size:13px !important;padding:0px" type="file" name="teacher_certificate"></div></div></div>
                                  </div>
                              </div>
                              
                               <h3>Are you a certified in ESL? </h3>
                              <div class="form-row">
                                 <div class="form-holder form-holder-2">
                                    <label class="form-row-inner">
                                    <input type="radio" onclick="$('#esl_certificate').show();"
                                       <?=($edit['f3_q_10']=='yes'||!isset($edit['f3_q_10']))?'checked':null?>
                                       name="f3_q_10" id="radio-r" value="yes"    >
                                    <span class="label">
                                    Yes</span>
                                    </label>
                                    <label class="form-row-inner">
                                    <input type="radio" onclick="$('#esl_certificate').hide();"
                                       ...
                                       name="f3_q_10" id="radio-r" value="no"    >
                                    <span class="label">
                                    No</span>
                                    </label>
                                 </div>
                                  <div class="form-holder" id="esl_certificate" >
                                    <div class="row"> <div class="col-md-12"> <div class="col-md-4"> Uplaod certification</div><div class="col-md-6"><input style="font-size:13px !important;padding:0px" type="file" name="esl_certificate"></div></div></div>
                                  </div>
                              </div>
                               
                                <h3>Are you billingual? </h3>
                              <div class="form-row">
                                 <div class="form-holder form-holder-2">
                                    <label class="form-row-inner">
                                    <input type="radio" onclick="$('#billingual_certificate').show();"
                                       <?=($edit['f3_q_11']=='yes'||!isset($edit['f3_q_11']))?'checked':null?>
                                       name="f3_q_11" id="radio-r" value="yes"    >
                                    <span class="label">
                                    Yes</span>
                                    </label>
                                    <label class="form-row-inner">
                                    <input type="radio" onclick="$('#billingual_certificate').hide();"
                                       ...
                                       name="f3_q_11" id="radio-r" value="no"    >
                                    <span class="label">
                                    No</span>
                                    </label>
                                 </div>
                                  <div class="form-holder" id="billingual_certificate" >
                                    <div class="row"> <div class="col-md-12"> <div class="col-md-4">Uplaod certification</div><div class="col-md-6"><input style="font-size:13px !important;padding:0px" type="file" name="billingual_certificate"></div></div></div>
                                  </div>
                              </div>
