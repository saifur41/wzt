	...
	**/ // tutorid
	...
	// echo $sql; 
	 $url_next='application.php';
      $ac=mysql_query($sql);
      // Update state of application  all_state_url all_state
						...
						<div class="wizard-form">
							...
							<div class="form-register" >
								<div id="form-total">
									...
									<section>
									  <form id="regForm" action="" method="post" enctype="multipart/form-data">
											        ...
											        <!-- Step1 --> 
														...
														<div class="form-row">
															<div class="form-holder form-holder-2">
																...
																<input type="radio"
																 ...
																 name="is_computer" id="radio-r" value="yes" required>
																	<span class="label">
																	Yes</span>
																</label>
															</div>
														...
														<div class="form-row">
															<div class="form-holder form-holder-2">
																<label class="form-row-inner">
																<input type="radio" 
																 <?=($edit['is_computer']=='no')?'checked':null?> name="is_computer"  value="no" id="radio-r" required>
																	<span class="label">
																	No</span>
																</label>
															</div>
														...
														<div class="form-row">
															<div class="form-holder form-holder-2">
																<input type="text" value="<?=$edit['started_date']?>"
														...
														<div class="form-row" style="display: none;" >
															...
															<div class="form-holder form-holder-2">
																	<button name="" class="btn btn-lg btn-primary btn-block" type="submit">Save</button>
										  ...
										  <div class="tab">
										     <div class="inner">
												<div class="form-row">
												 <h3>Show student how to answer the following question (enter URL to recording as answer)</h3> 
													<div class="form-holder form-holder-2">
														...
														<label class="form-row-inner">
														  <input type="text" name="f2_q_1" 
														  value="<?=$edit['f2_q_1']?>" class="form-control">
														</label>
													</div>
												</div>
												<div class="form-row">
												 <h3>Show student TWO methods to solve this question (enter URL to as answer)</h3> 
													<div class="form-holder form-holder-2">
													   <img src="https://lh5.googleusercontent.com/7AWmDgWBtpYIpZjfXfzzGy12E-hth_uF4_s8938jMo0-7j_f6uJKzdOHY1frOvNlj33qP5Q0jw=w740" class="img-responsive"  title="" alt="Captionless Image">
														<label class="form-row-inner">
														  <input type="text" name="f2_q_2"
														   value="<?=$edit['f2_q_2']?>" class="form-control">
														</label>
													</div>
												</div>
											</div>		
										    ...
										    <div class="inner">
												...
												<div class="form-row">
													<div class="form-holder form-holder-2">
														...
														<input type="radio"
														 ...
														 name="f3_q_3" id="radio-r" value="yes" required>
															<span class="label">
															Yes</span>
														</label>
													</div>
												...
												<div class="form-row">
													<div class="form-holder form-holder-2">
														<label class="form-row-inner">
														<input type="radio" 
														 <?=($edit['f3_q_3']=='no')?'checked':null?> name="f3_q_3"  value="no" id="radio-r" required>
															<span class="label">
															No</span>
														</label>
													</div>
												...
												<div class="form-row">
													<div class="form-holder form-holder-2">
														...
														<input type="radio"
														 ...
														 name="f3_q_4" id="radio-r" value="yes" required>
															<span class="label">
															Yes</span>
														</label>
													</div>
												...
												<div class="form-row">
													<div class="form-holder form-holder-2">
														...
														<input type="radio"
														 ...
														 name="f3_q_6" id="radio-r" value="opn_1" required>
															<span class="label">
														...
														<input type="radio"
														 ...
														 name="f3_q_6" id="radio-r" value="opn_2" required>
															<span class="label">
															1-3 years</span>
														</label>
														<label class="form-row-inner">
														<input type="radio"
														 ...
														 name="f3_q_6" id="radio-r" value="opn_3" required>
															<span class="label">
															3-5 year</span>
														</label>
														<label class="form-row-inner">
														<input type="radio"
														 ...
														 name="f3_q_6" id="radio-r" value="opn_4" required>
															<span class="label">
                                                    ...
                                                    $sel=(in_array($key,$save_subj_arr))?"checked":null; // checked
                                                     ...
                                                     ?>
														...
														<input type="checkbox"  <?=($data2['subjects']=='other')?'checked':null?>    name="subjects_other" 
														 id="radio-r" value="other" required>
															<span class="label">
															Other:<label class="form-row-inner">
														  <input type="text" name="subjects_other_text" 
												...
												<h3>Are you a certified Teacher?</h3>
												<div class="form-row">
													<div class="form-holder form-holder-2">
														<label class="form-row-inner">
														<input type="radio"
										  ...
										  <div class="tab">
												...
												<h3>Please take a clear photo of yourself and a photo ID, such that we can confirm your identity. We will need to clearly see your name and Photo to be accepted. (see example below) </h3>
												<div class="form-row">
													<div class="form-holder form-holder-2">
														<label class="form-row-inner">
									...
									<section>
                                    <h3>Next Step after applicaion completed  </h3> 
									</section>
...
function nextPrev(n) {
  ...
  // STOP //if (n == 1 && !validateForm()) return false;
