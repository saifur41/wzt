...
if($_POST['complete']) {
 ...
 // go to staut page // Calculate Score  // complete 
   ...
   $_SESSION['test_exam_result_id'] = $_SESSION['assessment']['ses_test_id'];
   unset($_SESSION['assessment']);
   unset($_SESSION['ses_quiz_type']);
 
  header("location:tutor_quiz_result.php"); exit;
...
if(empty($num))
  ...
  // $add_sql=mysql_query($add);
    ...
    header('Location:start_exam_test.php?pos=' . $next);
    exit;
    }else{
...
<div class="ct_heading clear">
                    ...
                    <div class="ct_display clear">                   
                        ...
                        <ul class="ul-list">
                          ...
                          <li style="border: none;list-style:none;">
                                        <div class="ques-text">
                                            <div style="float:left;margin-right:10px;font-size:18px" class="text-success"> <?=$current_qn?>. </div>
                                            <div class="questions-detail text-success"   style="font-size:18px"> 
                                            <?=$record['title']; //?>
                                           ...
                                           // print_r($opn_arr);
                                            ...
                                            <ul class="list-answers col-md-12">
                                                <li style="padding-bottom:10px">A )&nbsp;&nbsp;&nbsp;<input type="radio"
 ...
 <ul class="list-answers col-md-12">
                                            <li class="col-right" style="padding-bottom:10px">B )&nbsp;&nbsp;&nbsp;<input type="radio" 
                                            name="answer" value="1"  <?=($old_choose==1)?'checked':null?> >
                                            <?php  echo $opn_arr[1];?> </li>
                                          ...
                                          <ul class="list-answers col-md-12">
                                            ...
                                            <li style="padding-bottom:10px">C )&nbsp;&nbsp;&nbsp;<input type="radio"
                                            ...
                                            <li class="col-right" style="padding-bottom:10px">D )&nbsp;&nbsp;&nbsp;<input type="radio"
                                             name="answer" value="3" <?=($old_choose==3)?'checked':null?>   >
                                              <?php  echo $opn_arr[3];?></li>
                                        ...
                                        <div class="ques-button" style="border: none; ">
                                            <input type="hidden" name="question_id" value="<?=$record['id']?>">
                                                  <?php if ($prev != -1) { ?>
                                            <a href="start_exam_test.php?pos=<?php print $prev; ?>" class="btn btn-default submit_button"
                                              >Back</a>
                                            <?php } ?>
...
<div class="jumbotron" style="background-color: #fff;text-align: center">
  ...
  <span></p>
  <p><a class="btn btn-primary btn-lg" href="start_exam_test.php" role="button">Go Back and Check Work</a>
