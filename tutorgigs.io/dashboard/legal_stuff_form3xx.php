                                   ...
                                   <p class="text-success">Form 1 signed</p>
                                       ...
                                       <div title="signature 1 data">
                                        ...
                                        <script type="text/javascript">
                                         ...
                                         <a  href="training.php" 
                          class="btn btn-primary btn-sm"   >Go, Next Step</a>
                                         ...
                                         <br/>
											...
											<div class="form-row">
												...
												<div class="legal-box">
													...
													<!--  admin-signature::3rd Form Data. -->
													<?php  if($profile['is_legal_3']==0){?>
							 ...
							 <input type="text" class="tutor-input" name="xx" disabled="" value="<?=$_SESSION['login_user']?>"><br>
