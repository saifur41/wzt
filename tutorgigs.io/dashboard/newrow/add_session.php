 ...
 $selected_date= (!empty($_POST['select_date'][$i])) ?$_POST['select_date'][$i]: date("Y-m-d"); 
    ...
    // $arr['lesson']['end_time']=$end_time;
      ...
      $arr['lesson'][]=array('les_id'=>$_POST['lesson'][$i],
       ...
       $sql_session= " INSERT INTO int_schools_x_sessions_log SET board_type='$curr_active_board',type='intervention',activity_start_time='$activity_time',ses_start_time='$start_time',"
