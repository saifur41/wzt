...
//Signup State
 ...
 $profile_num=mysql_num_rows(mysql_query("SELECT * FROM `tutor_profiles` WHERE tutorid=".$_SESSION['ses_teacher_id']));


//////////Check for tutor profile not found//////
 if($profile_num < 1 )
 {
	$profile_num1=1;
 	//exit($profile_num1.'1-Error-previous profile not saved, Please contact the server administrator');

 	$a_url="https://tutorgigs.io/dashboard/application.php";

 	header("Location:".$a_url); exit;
 }
                                    ...
                                    <div title="signature 1 data">
                                    	<?php echo $profile['pri_tutor_sign'];?>
									                 ...
									                 <h3>Tutor (User)</h3> 
														 ...
														 <input type="text" class="tutor-input" value="<?=$tutor_full_name?>">
														 <br>
