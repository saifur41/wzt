...
$ContextId= "4512313";
$ses_tutor_id=$_SESSION['ses_teacher_id']; // tutorInterveneId
...
"context_id" =>$ses_arr['live_ses_id'], //"4512313" ,
// Room name
"context_title" => "Session_".$ses_arr['live_ses_id'] ,// Tutorgigs
);

  //print_r($launch_data); die; 
