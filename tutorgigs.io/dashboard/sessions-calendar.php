...
AND ses_start_time between '$getdate' AND '$end_date'  AND tut_teacher_id='$id' ";   # tut_status
         ...
         // Post reques to assign teacher# session-details.php?getid='.$sesid.'
                    $slot_str.='<a title="'.$str_title.'" href="'.$url.'" style=" margin:1% 0;"   class="'.$str_class.'">'.$old_end.'</a><br/>';#1
