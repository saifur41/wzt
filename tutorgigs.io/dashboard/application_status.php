					...
					<div class="wizard-v3-content">
						<div class="wizard-form">
                           ...
                           <a id="form-total-t-0" href="application.php" aria-controls="form-total-p-0"><div class="title">
									...
									<section>
										<div class="inner">
											<h3 class="text-center text-primary">Application Status</h3>
											...
											<div class="form-row">
												...
												<div id="content" class="col-md-12">
												Your application approved, steps completed .
												<!-- Your application approved, steps completed -->
												<!-- <button name="save" class="btn btn-lg btn-primary" type="submit">Vie</button> -->
								...
								<p class="text-right col-md-12"><button onclick="alert('coming soon');" class="btn btn-ig btn-success">Next</button></p>
