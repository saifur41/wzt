...
$edit=unserialize($profile['profile_1']);
  ...
  }elseif($profile['is_legal_1']==0){ // form1 not done
  	$next='legal_stuff.php';
...
//if(isset($_POST['Request'])){
  ...
  // $data['pri_tutor_sign']=$_POST['sign_done'];//Save image
   ...
   $data['term_form_name']=$_POST['sign_name'];
     ...
     unset($_POST['sign_done']); // not save in all data.
  //$data_str=serialize($data);
    $data_str=serialize($_POST);
   


   $up=" UPDATE tutor_profiles SET is_legal_3='1',legal_form3_data='$data_str',legal_form3_sign='$pri_tutor_sign' WHERE tutorid=".$_SESSION['ses_teacher_id'];
  // echo $up; die ;
 ...
 $profile=mysql_query("SELECT * FROM `tutor_profiles` WHERE is_legal_1=1 AND is_legal_2=1 AND is_legal_3=1 AND tutorid=".$_SESSION['ses_teacher_id']);
     ...
     if(mysql_num_rows($profile)==1){
     	...
     	$next_step=$_SESSION['ses_curr_state_url']='training.php';  //die; 
         ...
         //                            $(".multiple-input").keyup(function () {
									...
									<section>
									        <div class="page-container">
														 ...
														 <div class="col-md-11">
														    <div class="tax-form-form">
															     <div class="form-group">
																	...
																	<input type="text" name="name_income_tax" readonly=""
																	 value="<?=$tutor_full_name?>"  
																	 placeholder="name" class="form-control-2"  id="email">
																  </div>
																  <div class="form-group">
																	<label for="pwd">2	Business name/disregarded entity name, if different from above</label>
																	<input type="text" name="business_name" required placeholder="Business name" class="form-control-2" id="pwd">
																  </div>
																  <div class="row"  style="border-bottom:1px solid #000;">
																        <div class="col-md-8" style="padding:0px;">
																			...
																			<input name="tax_classification[]" type="checkbox" value="1">Individual/sole proprietor or single-member LLC
																				</label>
																				<label class="checkbox-inline">
																				  <input name="tax_classification[]" type="checkbox" value="2"> C Corporation 
																				</label>
																				<label class="checkbox-inline">
																				  <input name="tax_classification[]" type="checkbox" value="3">S Corporation 
																				</label>
																				<label class="checkbox-inline">
																				  <input name="tax_classification[]"  type="checkbox" value="4">Partnership
																				</label>
																				<label class="checkbox-inline">
																				  <input name="tax_classification[]" type="checkbox" value="5">Trust/estate
																				</label><br>
																				<label class="checkbox-inline">
																				  <input name="tax_classification[]"  type="checkbox" value="6">Limited liability company. Enter the tax classification (C=C corporation, S=S corporation, P=Partnership <input type="text" class="inline-vvv" id="pwd">
																				</label>
																				...
																				<label class="checkbox-inline">
																				  <input name="tax_classification_other" type="checkbox" value="">Other (see instructions) 
																				   <input name="limited_liability_text"  type="text" class="inline-vvv" id="pwd" >
																				</label>
																			 </div>
																	         ...
																	         <div class="tax-right" style=" min-height: 290px;">
																			    <div class="form-group">
																				 ...
																				 <div class="form-group">
																					...
																					<input placeholder="Exempt payee code"  required="" 
																					name="exempt_payee_code" type="text" class="form-control-2" id="email">
																				 </div>
																				 <div class="form-group">
																					<label for="email">Exemption from FATCA reporting code (if any)</label>
																					<input placeholder="Exemption from FATCA" required
																					 name="exempt_from_fatca" type="text" class="form-control-2" id="email">
																				 </div>
																        ...
																        <div class="col-md-7" style="padding:0px;">
                                                                            <div class="form-group">
																				...
																				<input placeholder="Address" required="" 
																				 name="income_tax_address" type="text" class="form-control-2" id="email">
																			</div>
																	        <div class="form-group">
																				<label for="email">6  City, state, and ZIP code</label>
																				<input placeholder="City, state, and ZIP code"  required
																				name="income_tax_address_city" type="text" class="form-control-2" id="email">
																			</div>
																	    </div>
																  ...
																  <div class="form-group">
																		...
																		<input placeholder="List account number(s)" required="" 
																		 type="text"name="list_account_number" class="form-control-2" id="email">
																  </div>
															</div>
														 </div>
													</div>
												...
												<?php  include "home_sign3_form.php";?>
												...
												<!--  form Field -->
													  ...
													  <!-- Sinature rows -->
															...
															<div class="col-md-10">
															      <div class="form-inline" >
																	  <div class="form-group">
																		<!-- <label for="email">Signature of U.S. person </label> -->
																		<!-- <input placeholder="Signature" name="signature_person" type="text" class="form-control-3"> -->
																		 <div  id="xxsign_result_sttp" style="visibility: hidden;" > ddff</div>
																	  </div>
																	  <div class="form-group">
																		<label for="pwd"> Date:</label>
																		<!-- <input placeholder="date" name="signature_date" type="date" class="form-control-3"> -->
																		<input placeholder="date" readonly="" name="signature_date" type="text" value="<?=date('d/m/Y')?>" 
														...
														<!-- Submit --> 
											<!-- <button type="submit" name="Request" class="btn btn-primary btn-sm" id="btn btn-lg btn-primary">Submit Form2</button> -->
								 ...
								 <button type="submit" name="Request" class="btn btn-danger btn-sm" id="btn btn-lg btn-primary">Submit Form</button>
								 </p>
