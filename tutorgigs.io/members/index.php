...
<html>
<head>
<title>Your Tutoring Dashboard</title>
	...
	<div class="col-sm-3">
		<ul class="nav nav-pills nav-stacked">
		  <li class="active"><a href="#">My Profile</a></li>
					 <li><a href="#">My Tutoring Gigs</a></li>
	        <li><a href="#">Qualifying Tests</a></li>
	        <li><a href="#">Lesson Plans and Resources</a></li>
					<li><a href="#">Launch a Tutoring Session</a></li>
	        <li><a href="#">Complete Survey</a></li>
